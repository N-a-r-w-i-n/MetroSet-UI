...
{
    public class MetroSetForm : Form, iMetroSetForm
    {
        private const int WM_NCHITTEST = 0x0084;
        private const int HTCLIENT = 0x01;
        private const int HTCAPTION = 0x02;
        private Utilites utl = new Utilites();
        ...
        private bool drawLeftRect = true;

        [Category("MetroSet Framework")]
        public bool DrawLeftRect
        {
            get { return drawLeftRect; }
            set
            {
                drawLeftRect = value;
                Invalidate();
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            else
            {
                ...
                if (displayHeader)
                {
                    ...
                    {
                        case TextAlign.Left:
                            e.Graphics.DrawString(Text, Font, textBrush, new Point(20, 15));
                            break;

                        case TextAlign.Center:
                            using (StringFormat stringFormat = new StringFormat() { Alignment = StringAlignment.Center })
                            {
                                e.Graphics.DrawString(Text, Font, textBrush, new Rectangle(20,15,Width - 21, Height), stringFormat);
                            }
                            break;
                        ...
                        case TextAlign.Right:
                            ...
                            {
                                e.Graphics.DrawString(Text, Font, textBrush, new Point(Width - 21, 15), stringFormat);
                            }
                            break;
                    }
                }
        ...
        private FormProperties prop = new FormProperties();
        ...
        //private ThemeReader themeRader = new ThemeReader();
                ...
                case Style.Custom:
                    if (StyleManager != null)
                        foreach (var varkey in StyleManager.FormDictionary)
                        {
                            ...
                            else if (varkey.Key == "DisplayHeader")
                            {
        ...
        public void SetProperties()
        {
            try
            {
                ...
                DisplayHeader = prop.DisplayHeader;
                DrawLeftRect = prop.DrawLeftRect;
